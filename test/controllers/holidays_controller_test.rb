...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { author: @holiday.author, place: @holiday.place } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { author: @holiday.author, place: @holiday.place } }
